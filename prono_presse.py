...
# Sauvegarde debug
with open("debug_boturfers.html", "w", encoding="utf-8") as f:
    f.write(response.text)
print("Page HTML sauvegardée dans debug_boturfers.html")

soup = BeautifulSoup(response.text, "html.parser")

# Compte les tableaux trouvés
...
print("Nombre de lignes dans le tableau :", len(rows))
